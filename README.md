...
Using the public multiome dataset GSE262189 (~42,000 nuclei across six neuroblastoma cell lines), the project evaluates deep learning models that learn a joint RNA–ATAC latent representation of cellular states. The primary goal is to determine whether chromatin accessibility information provides additional biological and predictive value beyond gene expression alone.
...
## Project Structure
```
├── data/                  # Raw and processed data (not included in repositoty)
...
- Interpret learned biological signals through: Peak-to-gene linking, Transcription factor motif accessibility, MYCN-associated regulatory programs
